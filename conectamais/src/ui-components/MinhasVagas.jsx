...
export default function MinhasVagas(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "MinhasVagas")}
      {...rest}
    >
      <View
        width="1849px"
      ...
      >
        ...
        >
          <Icon
            ...
            left="0%"
            right="87.87%"
            {...getOverrideProps(overrides, "Vector41051345")}
          ></Icon>
          <Text
          ...
          <Icon
            ...
            top="7px"
            left="270px"
            {...getOverrideProps(overrides, "Vector41051347")}
          ></Icon>
          <Icon
            width="36px"
            height="42px"
            ...
            left="22.8%"
            right="68.47%"
            {...getOverrideProps(overrides, "Vector41051348")}
          ></Icon>
          <Icon
            width="47px"
            height="45px"
            ...
            left="42.44%"
            right="46.16%"
            {...getOverrideProps(overrides, "Vector41051349")}
          ></Icon>
        </View>
      </View>
      <Text
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Minhas Vagas"
        {...getOverrideProps(overrides, "Minhas Vagas")}
      ></Text>
      <View
        width="1560px"
        height="380px"
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(255,255,255,1)"
        {...getOverrideProps(overrides, "Rectangle 19339886708")}
      ></View>
      <View
        width="1560px"
        height="303px"
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(255,255,255,1)"
        {...getOverrideProps(overrides, "Rectangle 19339886709")}
      ></View>
      <SearchField
        width="727px"
        height="unset"
      ...
      <View
        ...
        top="470px"
        left="160px"
        {...getOverrideProps(overrides, "Group 424")}
      >
        <Text
          fontFamily="Montserrat"
          fontSize="36px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="22/02/2024"
          {...getOverrideProps(overrides, "22/02/202439886717")}
        ></Text>
        <Text
          fontFamily="Montserrat"
          fontSize="14px"
          ...
          whiteSpace="pre-wrap"
          children="22/02/2024"
          {...getOverrideProps(overrides, "22/02/202439886718")}
        ></Text>
        <Text
          fontFamily="Montserrat"
          fontSize="20px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="1 Vaga: São Paulo - SP"
          {...getOverrideProps(
            overrides,
            "1 Vaga: S\u00E3o Paulo - SP39886719"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Qual será sua missão:  Você será responsável por coletar, organizar e analisar grandes volumes de dados, fornecendo insights valiosos para a tomada de decisões estratégicas. Entre as principais responsabilidades estão a criação de relatórios, identificação de padrões e tendências, e o desenvolvimento de soluções para otimizar processos internos. "
          {...getOverrideProps(
            overrides,
        ...
        <Button
          ...
          {...getOverrideProps(overrides, "Button39886721")}
        ></Button>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="R$ 4.700,00"
          {...getOverrideProps(overrides, "R$ 4.700,00")}
        ></Text>
        <Text
          fontFamily="Montserrat"
          fontSize="20px"
        ...
        <Button
          ...
          variation="primary"
          children="Aprovada"
          {...getOverrideProps(overrides, "Button39886727")}
        ></Button>
      </View>
      <Image
        width="104px"
      ...
      <Button
        ...
        variation="primary"
        children="Vagas"
        {...getOverrideProps(overrides, "Button41002154")}
      ></Button>
      <Button
        width="107px"
        height="36px"
        ...
        variation="primary"
        children="Perfil"
        {...getOverrideProps(overrides, "Button41002155")}
      ></Button>
      <Button
        width="107px"
        height="36px"
        ...
        variation="primary"
        children="Plus"
        {...getOverrideProps(overrides, "Button41002156")}
      ></Button>
    </View>
  );
}
