...
export default function Cadastro1(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "Cadastro1")}
      {...rest}
    >
      <Icon
        width="2073.6px"
      ...
      <Icon
        ...
        left="-10%"
        right="-10%"
        {...getOverrideProps(overrides, "Vector40211819")}
      ></Icon>
      <View
        padding="0px 0px 0px 0px"
        width="1728px"
          ...
          >
            ...
            >
              <Icon
                ...
                left="12.5%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vector4022836")}
              ></Icon>
            </View>
          </View>
        </View>
      ...
      <Button
        ...
        {...getOverrideProps(overrides, "Button40211830")}
      ></Button>
    </View>
  );
}
