...
import { getBancoImagens } from "../graphql/queries";
import { updateBancoImagens } from "../graphql/mutations";
const client = generateClient();
export default function BancoImagensUpdateForm(props) {
  const {
    id: idProp,
    bancoImagens: bancoImagensModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = bancoImagensRecord
      ? { ...initialValues, ...bancoImagensRecord }
      : initialValues;
    setEmpresaExemplo(cleanValues.EmpresaExemplo);
    setImagemDeFundo(cleanValues.ImagemDeFundo);
    setLogoBrancaConecta(cleanValues.LogoBrancaConecta);
    setLogoFundoBrancoConecta(cleanValues.LogoFundoBrancoConecta);
    setLogoAzulConecta(cleanValues.LogoAzulConecta);
    setPerfilFotoExemploReal(cleanValues.PerfilFotoExemploReal);
    setInteligenciaArtificial(cleanValues.InteligenciaArtificial);
    setLogoPretaConecta(cleanValues.LogoPretaConecta);
    setBackground2(cleanValues.Background2);
    setJoiaSenha(cleanValues.JoiaSenha);
    setChavesSenha(cleanValues.ChavesSenha);
    setPerfilSemFoto(cleanValues.PerfilSemFoto);
    setGoogleLogo(cleanValues.GoogleLogo);
    setFacebookLogo(cleanValues.FacebookLogo);
    setJoiaTelefone(cleanValues.JoiaTelefone);
    setPerfilAvatar(cleanValues.PerfilAvatar);
    setPost1(cleanValues.Post1);
    setPost2(cleanValues.Post2);
    setPost3(cleanValues.Post3);
    setPost4(cleanValues.Post4);
    setPost5(cleanValues.Post5);
    setMonicaIPerfil(cleanValues.MonicaIPerfil);
    setErrors({});
  };
  const [bancoImagensRecord, setBancoImagensRecord] = React.useState(
    bancoImagensModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getBancoImagens.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getBancoImagens
        : bancoImagensModelProp;
      setBancoImagensRecord(record);
    };
    queryData();
  }, [idProp, bancoImagensModelProp]);
  React.useEffect(resetStateValues, [bancoImagensRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          EmpresaExemplo: EmpresaExemplo ?? null,
          ImagemDeFundo: ImagemDeFundo ?? null,
          LogoBrancaConecta: LogoBrancaConecta ?? null,
          LogoFundoBrancoConecta: LogoFundoBrancoConecta ?? null,
          LogoAzulConecta: LogoAzulConecta ?? null,
          PerfilFotoExemploReal: PerfilFotoExemploReal ?? null,
          InteligenciaArtificial: InteligenciaArtificial ?? null,
          LogoPretaConecta: LogoPretaConecta ?? null,
          Background2: Background2 ?? null,
          JoiaSenha: JoiaSenha ?? null,
          ChavesSenha: ChavesSenha ?? null,
          PerfilSemFoto: PerfilSemFoto ?? null,
          GoogleLogo: GoogleLogo ?? null,
          FacebookLogo: FacebookLogo ?? null,
          JoiaTelefone: JoiaTelefone ?? null,
          PerfilAvatar: PerfilAvatar ?? null,
          Post1: Post1 ?? null,
          Post2: Post2 ?? null,
          Post3: Post3 ?? null,
          Post4: Post4 ?? null,
          Post5: Post5 ?? null,
          MonicaIPerfil: MonicaIPerfil ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateBancoImagens.replaceAll("__typename", ""),
            variables: {
              input: {
                id: bancoImagensRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "BancoImagensUpdateForm")}
      {...rest}
    >
      <TextField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || bancoImagensModelProp)}
