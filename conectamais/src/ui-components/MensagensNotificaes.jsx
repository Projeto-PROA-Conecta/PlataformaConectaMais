...
export default function MensagensNotificaes(props) {
  ...
  return (
    ...
    >
      <Icon
        width="186px"
        height="625px"
        viewBox={{ minX: 0, minY: 0, width: 186, height: 625 }}
        paths={[
          {
        ...
        top="308px"
        left="1333px"
        {...getOverrideProps(overrides, "Rectangle 109")}
      ></Icon>
      <View
        padding="0px 0px 0px 0px"
        width="888.58px"
        ...
        top="281px"
        left="253px"
        {...getOverrideProps(overrides, "Group 395")}
      >
        <View
          width="839.47px"
          height="668.1px"
        ...
        <Image
          ...
          padding="0px 0px 0px 0px"
          objectFit="cover"
          src={bancoImagens?.PerfilSemFoto}
          {...getOverrideProps(overrides, "AvatarPerfil 2")}
        ></Image>
        <Image
          width="77.48px"
          height="101.06px"
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Mateus Souza comentou a publicação de Mariana Portela: Foi fantástico!"
          {...getOverrideProps(
            overrides,
            "Mateus Souza comentou a publica\u00E7\u00E3o de Mariana Portela: Foi fant\u00E1stico!"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Maria Silva comentou a publicação de Mariana Portela: Foi fantástico!"
          {...getOverrideProps(
            overrides,
            "Maria Silva comentou a publica\u00E7\u00E3o de Mariana Portela: Foi fant\u00E1stico!"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="João Melo e outras pessoas adicionaram 5 comentários à publicação de Lucas"
          {...getOverrideProps(
            overrides,
            "Jo\u00E3o Melo e outras pessoas adicionaram 5 coment\u00E1rios \u00E0 publica\u00E7\u00E3o de Lucas"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="3 h"
          {...getOverrideProps(overrides, "3 h")}
        ></Text>
        <Image
          width="77.48px"
          height="101.06px"
          ...
          objectFit="cover"
          src={bancoImagens?.PerfilSemFoto}
          {...getOverrideProps(overrides, "AvatarPerfil 5")}
        ></Image>
        <View
          width="586.78px"
          height="185.31px"
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Parabéns pela sua conquista, Lucas! ❤️"
          {...getOverrideProps(
            overrides,
            "Parab\u00E9ns pela sua conquista, Lucas! \u2764\uFE0F"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="55 reações - 5 comentários"
          {...getOverrideProps(
            overrides,
            "55 rea\u00E7\u00F5es - 5 coment\u00E1rios"
          )}
        ></Text>
        <Text
          fontFamily="Montserrat"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Gente, acabei de conquistar meu primeiro emprego na New Berg, mal posso esperar pelo..."
          {...getOverrideProps(
            overrides,
            "Gente, acabei de conquistar meu primeiro emprego na New Berg, mal posso esperar pelo..."
          )}
        ></Text>
        <Icon
          width="587.63px"
          height="0px"
          viewBox={{ minX: 0, minY: 0, width: 587.6304931640625, height: 1 }}
          paths={[
            {
              d: "M0 0L587.63 0L587.63 -1L0 -1L0 0Z",
              stroke: "rgba(0,0,0,1)",
              fillRule: "nonzero",
              strokeWidth: 1,
            },
        ...
        <Icon
          width="839.27px"
          height="0px"
          viewBox={{ minX: 0, minY: 0, width: 839.2733154296875, height: 1 }}
          paths={[
            {
              d: "M0 0L839.273 0L839.273 -1L0 -1L0 0Z",
              stroke: "rgba(0,0,0,1)",
              fillRule: "nonzero",
              strokeWidth: 1,
            },
          ...
          top="153.93px"
          left="0.63px"
          {...getOverrideProps(overrides, "Line 22")}
        ></Icon>
        <Icon
          width="839.27px"
          height="0px"
          ...
          top="312.14px"
          left="0px"
          {...getOverrideProps(overrides, "Line 23")}
        ></Icon>
        <Image
          width="65.11px"
          height="86.61px"
          ...
          objectFit="cover"
          src={bancoImagens?.PerfilSemFoto}
          {...getOverrideProps(overrides, "AvatarPerfil 6")}
        ></Image>
      </View>
      <Text
        ...
        whiteSpace="pre-wrap"
        children="Conversas"
        {...getOverrideProps(overrides, "Conversas")}
      ></Text>
      <Text
        fontFamily="Montserrat"
        fontSize="14px"
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Você ainda não tem mensagens :(&#x2028;&#x2028;"
        {...getOverrideProps(
          overrides,
      ...
      <Text
        ...
        alignItems="unset"
        position="absolute"
        top="calc(50% - 29.5px - -58.5px)"
        left="1350px"
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Vamos nos Conetar+&#xA; mande messagens para as&#xA; pessoas ou empresas"
        {...getOverrideProps(
          overrides,
          "Vamos nos Conetar+ mande messagens para as pessoas ou empresas"
        )}
      ></Text>
      <Flex
        gap="40px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 3214367696")}
        >
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector4367697")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector4367698")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector4367699")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector4367700")}
          ></Icon>
        </Flex>
        <Flex
          gap="10px"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 3214367703")}
        >
          <Button
            width="165px"
            height="30px"
            ...
            variation="primary"
            children="Entrar"
            {...getOverrideProps(overrides, "Button4367704")}
          ></Button>
          <Button
            width="165px"
            height="30px"
            ...
            {...getOverrideProps(overrides, "Button4367705")}
          ></Button>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 32143291000")}
        >
          <Button
            width="70px"
            height="28px"
            ...
            variation="primary"
            children="Perfil"
            {...getOverrideProps(overrides, "Button43291001")}
          ></Button>
          <Button
            width="70px"
            height="28px"
            ...
            variation="primary"
            children="Vagas"
            {...getOverrideProps(overrides, "Button43291002")}
          ></Button>
          <Button
            width="70px"
            height="28px"
            ...
            variation="primary"
            children="Plus"
            {...getOverrideProps(overrides, "Button43291003")}
          ></Button>
        </Flex>
      </Flex>
    </View>
