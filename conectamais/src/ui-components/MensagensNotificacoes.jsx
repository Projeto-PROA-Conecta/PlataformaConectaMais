...
export default function MensagensNotificacoes(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "MensagensNotificacoes")}
      {...rest}
    >
      <Image
        width="1519px"
      ...
      <Icon
        ...
        paths={[
          {
            d: "M186 0L187 0L187 -1L186 -1L186 0ZM186 625L186 626L187 626L187 625L186 625ZM30 1L186 1L186 -1L30 -1L30 1ZM185 0L185 625L187 625L187 0L185 0ZM186 624L30 624L30 626L186 626L186 624ZM1 595L1 30L-1 30L-1 595L1 595ZM30 624C13.9837 624 1 611.016 1 595L-1 595C-1 612.121 12.8792 626 30 626L30 624ZM30 -1C12.8792 -1 -1 12.8792 -1 30L1 30C1 13.9837 13.9837 1 30 1L30 -1Z",
            stroke: "rgba(0,0,0,1)",
            fillRule: "nonzero",
            strokeWidth: 1,
          },
      ...
      >
        ...
        >
          <Icon
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector38511742")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector38511743")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector38511744")}
          ></Icon>
          <Icon
            width="20px"
            height="20px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector38511745")}
          ></Icon>
        </Flex>
      </Flex>
    </View>
